...
$invoice1 = new \App\ObjectComparison\Invoice(new \App\ObjectComparison\Customer('Customer 1'), 25, 'My Invoice');
$invoice2 = new \App\ObjectComparison\Invoice(new \App\ObjectComparison\Customer('Customer 1'), 25, 'My Invoice');
